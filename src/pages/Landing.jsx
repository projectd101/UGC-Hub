...
const CREATORS = [
  ...
  { id: "alex-22", name: "Alex Morgan", handle: "@alexmorgan", reactions: ["Shocked", "Excited", "Confused", "Happy"], niches: ["AI tools", "Productivity", "Fintech"], clips: 100, price: 49, videos: ["/videos/22.mp4"] },
  { id: "mia-33", name: "Mia Carter", handle: "@miacarter", reactions: ["Excited", "Happy", "Skeptical", "Crying"], niches: ["Social apps", "Dating", "Ecommerce"], clips: 100, price: 59, videos: ["/videos/33.mp4"] },
  { id: "jordan-44", name: "Jordan Lee", handle: "@jordanlee", reactions: ["Shocked", "Frustrated", "Confused", "Relaxed"], niches: ["Mobile games", "Education", "AI tools"], clips: 50, price: 29, videos: ["/videos/44.mp4"] },
];
