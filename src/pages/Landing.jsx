    ...
    <div className={styles.page}>
      ...
      <main>
        ...
        <section className={styles.compare}>
          <article className={styles.compareCol}><header className="compareHeader"><span className={styles.sectionKicker}>The old way</span><h2>Different face every time.</h2></header><ul><li>Search for creators for every campaign</li><li>Inconsistent look and audience recognition</li><li>Generic stock UGC gets reused everywhere</li><li>Hard to build a recognizable content identity</li></ul></article>
          <article className={styles.compareColAccent}><header className="compareHeader"><span className={styles.sectionKicker}>UGC Hub</span><h2>One face. A whole reaction bank.</h2></header><ul><li>Choose a creator once</li><li>Buy 50 or 100 clips in one bundle</li><li>Multiple emotions from the same person</li><li>Keep your brand's UGC visually consistent</li></ul></article>
        </section>
        ...
        <section id="pricing" className={styles.bundleSection}><div className={styles.bundleCopy}><span className={styles.sectionKicker}>Simple pricing</span><h2 className={styles.sectionHeadline}>A complete reaction library, not a single clip.</h2><p className={styles.sectionSub}>Buy the amount you actually need and keep your content consistent across campaigns.</p></div><div className={styles.bundleCards}><article><div className="bundleCardTop"><span>Starter</span><strong>50 clips</strong><b>$22</b><small>One creator · Multiple reactions</small></div><ul className="bundleFeatures"><li>50 short-form reaction videos</li><li>Multiple emotions from one face</li><li>9:16 social-ready format</li><li>Built for ads and organic content</li></ul><button onClick={goToSignIn}>Browse 50-clip bundles</button></article><article className={styles.featuredBundle}><div className="bundleCardTop"><span>Full library</span><strong>100 clips</strong><b>$40</b><small>One creator · Complete reaction bank</small></div><ul className="bundleFeatures"><li>100 short-form reaction videos</li><li>Broader emotion coverage</li><li>9:16 social-ready format</li><li>Best value for recurring campaigns</li></ul><button onClick={goToSignIn}>Browse 100-clip bundles</button></article></div></section>
