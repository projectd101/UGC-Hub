    ...
    <div className={styles.page}>
      ...
      <main>
        <section className={styles.hero}>
          <div className={styles.heroCopy}><span className={styles.eyebrow}>THE UGC MARKETPLACE FOR REAL REACTIONS</span><h1 className={styles.heroHeadline}>Buy a library of reactions.<br /><em>Keep the same face.</em></h1><p className={styles.heroSub}>Get 50 or 100 high-quality facial reaction clips from one real creator. Browse by emotion and niche, choose a face that fits your brand, and build a consistent UGC library.</p><div className={styles.heroCtas}><button className={styles.primaryBtn} onClick={goToSignIn}>Browse creators</button><button className={styles.secondaryBtn} onClick={goToSignIn}>Become a creator</button></div><div className={styles.heroProof}><span>REAL PEOPLE</span><span>9:16 CLIPS</span><span>50–100 CLIPS / BUNDLE</span><span>COMMERCIAL USE</span></div></div>
          <div className={styles.heroVisual}>
            <div className={`${styles.videoTile} ${styles.tileOne}`}><video src="/videos/1.mp4" autoPlay muted loop playsInline preload="metadata" /><span>SHOCKED</span></div>
            <div className={`${styles.videoTile} ${styles.tileTwo}`}><video src="/videos/2.mp4" autoPlay muted loop playsInline preload="metadata" /><span>EXCITED</span></div>
            <div className={`${styles.videoTile} ${styles.tileThree}`}><video src="/videos/3.mp4" autoPlay muted loop playsInline preload="metadata" /><span>CONFUSED</span></div>
