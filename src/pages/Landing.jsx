      ...
      <main>
        ...
        <section className={styles.compare}>
          <article className={styles.compareCol}>
            <header className="compareHeader"><span className={styles.sectionKicker}>The old way</span><h2>Different face every time.</h2></header>
          ...
          <article className={styles.compareColAccent}>
            <header className="compareHeader"><span className={styles.sectionKicker}>UGC Hub</span><h2>One face. A whole reaction bank.</h2></header>
