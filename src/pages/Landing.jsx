...
const CREATORS = [
  { id: "alex-11", name: "Alex Morgan", handle: "@alexmorgan", reactions: ["Shocked", "Excited", "Confused", "Happy"], niches: ["AI tools", "Productivity", "Fintech"], clips: 100, price: 49, videos: ["/videos/11.mp4"] },
  { id: "alex-22", name: "Alex Morgan", handle: "@alexmorgan", reactions: ["Shocked", "Excited", "Confused", "Happy"], niches: ["AI tools", "Productivity", "Fintech"], clips: 200, price: 49, videos: ["/videos/22.mp4"] },
  { id: "mia-33", name: "Mia Carter", handle: "@miacarter", reactions: ["Excited", "Happy", "Skeptical", "Crying"], niches: ["Social apps", "Dating", "Ecommerce"], clips: 150, price: 59, videos: ["/videos/33.mp4"] },
  { id: "jordan-44", name: "Jordan Lee", handle: "@jordanlee", reactions: ["Shocked", "Frustrated", "Confused", "Relaxed"], niches: ["Mobile games", "Education", "AI tools"], clips: 100, price: 29, videos: ["/videos/44.mp4"] },
];
  ...
  return (
    <div className={styles.page}>
      ...
      <main>
        ...
        <section id="marketplace" className={styles.marketplace}><div className={styles.sectionTop}><div><span className={styles.sectionKicker}>Marketplace</span><h2 className={styles.sectionHeadline}>Find the face your brand needs.</h2><p className={styles.sectionSub}>Every creator has a defined reaction library, niches, and available video count.</p></div><button className={styles.textBtn} onClick={goToSignIn}>View all creators →</button></div>
