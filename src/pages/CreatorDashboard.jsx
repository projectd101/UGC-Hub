      ...
      <div className={styles.appArea}>
        ...
        <main className={styles.main}>
          ...
          {tab === "videos" && <section className={styles.studioSection}>
            ...
            {uploadError && <p style={{ color: "#ff6b5c", fontSize: 12.5 }}>{uploadError}</p>}
